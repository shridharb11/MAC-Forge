# MAC-Forge
MAC’n’Roll is a Verilog HDL project that implements a systolic array based matrix multiplication engine. This project focuses on the fundamental building block: a parallel grid of Multiply-Accumulate (MAC) units.
